...
./build/tools/releasetools/ota_from_target_files -k ~/.android-certs/releasekey --block signed-target_files.zip pa_zl1-7.3.5-UNOFFICIAL-$PERSONAL_BUILD_DATE-signed.zip
